...
export default class InitScene extends Phaser.Scene {
  ...
  map_json?:world_map
  objects: objectTuple[]
  constructor(config:Phaser.Types.Scenes.SettingsConfig, id:string,setGameEvent:Function, reactEvent:EventAcrossComponents) {
		super(config)
...
// size:
    ...
    //   // this.add.image()
    // })
    const background = this.add.tileSprite(window.innerWidth/2, window.innerHeight/2, window.innerWidth, window.innerHeight, "tile");
